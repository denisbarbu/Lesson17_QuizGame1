...
def add_question(all_questions: list, questions_path: str = "questions.json"):
    try:
        ...
        correct_answer = int(input("Introdu una din cifre pentru raspuns corect: "))
        ...
        logger.error(f"Error on adding question {e}")
...
def delete_question(all_questions: list, questions_path: str = "questions.json"):
    try:
        ...
        question_to_delete= int(input("Introdu indexul intrebarii pe care vrei sa o stergi: "))
